...
png("Duration of authority patterns 1800-2010 by region.png")
...
fit.by.region3 <- survfit(Surv(time=demdurationyrs,event=demdead) ~ demstatus + un_continent_name,data=polity2)
